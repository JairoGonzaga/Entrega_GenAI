...
description: "Use when: designing product interfaces such as dashboards, admin panels, apps, tools, and data-heavy screens before coding. Not for marketing pages."
---

# Interface Design

Design product interfaces with craft and consistency.

## Scope

**Use for:** Dashboards, admin panels, SaaS apps, tools, settings pages, data interfaces.

**Not for:** Landing pages, marketing sites, campaigns. Use `frontend-design` for implementation-focused requests.
...
## Suggest + Ask
Lead with exploration and recommendation, then confirm direction:
1. Domain: 5+ concepts from the product world.
2. Color world: 5+ domain-native colors.
3. Signature: one visual or interaction element unique to the product.
4. Replacing defaults: name 3 defaults and 3 alternatives.
...
5. Evaluate — run the review checks before presenting

## Copilot Notes
- Keep recommendations actionable and tied to current repository constraints.
- Prefer concrete design decisions over abstract adjectives.
- Avoid inventing unsupported commands or external tool workflows.